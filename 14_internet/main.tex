...
% \subsection{TCP, UDP}
% \begin{frame}{Protokoly - TCP, UDP}
% \begin{columns}
%     \begin{column}{0.48\textwidth}
%         \textbf{\large TCP - Transmission Control Protocol}
%         \begin{itemize}
%             \item Spolehlivý.
%             \item Zajišťuje doručení dat v přesném pořadí.
%         \end{itemize}
%     \end{column}
%     \begin{column}{0.48\textwidth}
%         \textbf{\large UDP - User Datagram Protocol}
%         \begin{itemize}
%             \item Nespolehlivý, rychlý.
%             \item Nedává záruku doručení dat.
%             \item Může vést ke ztrátě dat.
%             \item Používá se ve hrách pro user input například.
%         \end{itemize}
%     \end{column}
% \end{columns}
% \end{frame}
